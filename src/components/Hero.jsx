...
const Hero = () => {
  return (
    <div className="py-20">
      <div className="w-4/5 m-auto bg-[url('/hero_image.svg')] h-[500px] rounded-xl bg-cover flex items-center">
        <div className="w-1/2  p-20 space-y-5">
          <h1 className="text-6xl font-bold">Order Your Daily Groceries </h1>
          <p className="text-xl font-semibold text-green-900">#Free Delivery</p>
          <div className="h-12 bg-white rounded-full flex items-center space-x-2">
            ...
            />
            <button className="w-36 rounded-full bg-green-500 text-white h-full">
              Search
            </button>
          </div>
        </div>
